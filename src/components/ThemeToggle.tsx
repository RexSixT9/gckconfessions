...
export default function ThemeToggle() {
  ...
  return (
    <Button
      ...
      className="border border-border text-foreground hover:border-accent/60 hover:bg-accent/12 hover:text-accent focus-visible:ring-ring/60 max-[430px]:size-8"
    >
      {isDark ? (
